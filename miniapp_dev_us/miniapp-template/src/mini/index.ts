...
export enum SoterType {
  Fingerprint = 'Fingerprint',
  Facial = 'Facial'
}

export enum SoterErrorCode {
...
const mini = {
  ...
  closeMiniapp: () => {
    return new Promise<void>((resolve, reject) => {
      ...
      // #ifndef H5
      setTimeout(() => {
        plus.runtime.quit(); // Fault-Tolerant Mechanism
      }, 200);
      // @ts-ignore
